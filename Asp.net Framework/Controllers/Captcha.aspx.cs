...
namespace Asp.net_Framework.Controllers
{
    public partial class Captcha : System.Web.UI.Page
    {
        ...
        {
            Bitmap objBitmap = new Bitmap(215, 107);
            ...
            objGraphics.DrawRectangle(Pens.Red, objRandom.Next(0, 20), objRandom.Next(0, 20), objRandom.Next(50, 80), objRandom.Next(0, 20));
            ...
            objBitmap.Save(sm, ImageFormat.Png);
            Response.Write(Convert.ToBase64String(sm.ToArray()));
